...
public class RegisterDetailsResponse {
    ...
    private String nStep; // comes as string "1","2","3"
    ...
    /** Returns n_step as int safely (defaults to 1). */
    public int getNStep() {
        try {
            return Integer.parseInt(nStep);
        } catch (Exception e) {
            return 1;
        }
    }
    ...
    public static class JData {
        ...
        @SerializedName("is_informations")
        private IsInformations isInformations;
    ...
    public static class AddressDetails {
        ...
        public String getNAddressType() { return nAddressType; }
